...
def sc_ranges():
    # Get the ranges of special double-width characters using direct Unicode code points.
    special_char_ranges = [
        {"from": 0x4E00, "to": 0x9FFF},  # CJK Unified Ideographs
        {"from": 0x3040, "to": 0x30FF},  # Hiragana and Katakana
        {"from": 0xAC00, "to": 0xD7A3},  # Hangul Syllables
        {"from": 0xFF01, "to": 0xFF60},  # Fullwidth forms
    ]
